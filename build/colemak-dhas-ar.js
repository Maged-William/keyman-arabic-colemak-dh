...
KeymanWeb.KR(new Keyboard_colemak_dhas_ar());

function Keyboard_colemak_dhas_ar()
{
  
  this._v=(typeof keyman!="undefined"&&typeof keyman.version=="string")?parseInt(keyman.version,10):9;
  this.KI="Keyboard_colemak_dhas_ar";
  this.KN="colemak-dh-arabic-pro";
  this.KMINVER="9.0";
  this.KV=null;
  this.KDU=0;
  this.KH='';
